# <div align='center'>AustiinOffc Baileys - A WebSockets library for interacting with WhatsApp Web</div>

<div align="center">


**AustiinOffc Baileys** is a fast, stable, and modern interactive-feature-focused WhatsApp Web API library built on WebSocket.
...
```bash
cd path/to/AustiinOffc Baileys
node example.js
```
...
```
npm install AustiinOffc/Baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)

```
npm install github:AustiinOffc/Baileys
```

Then import your code using:

```js
import makeWASocket from 'AustiinOffc/Baileys'
```
...
```js
import makeWASocket, { useMultiFileAuthState } from 'AustiinOffc/Baileys'
...
```js
import makeWASocket, { DisconnectReason, useMultiFileAuthState } from 'AustiinOffc/Baileys'
...
import { makeInMemoryStore, getAggregateVotesInPollMessage } from 'AustiinOffc/Baileys'

const logger = pino({ timestamp: () => `,"time":"${new Date().toJSON()}"` }).child({
    class: 'AustiinOffc/Baileys',
})
logger.level = 'fatal'
...
async function getMessage(key) {
    ...
    return {
        conversation: 'AustiinOffc/Baileys',
    }
}
...
```js
import { jidNormalizedUser, getAggregateResponsesInEventMessage } from 'AustiinOffc/Baileys'
...
```js
import makeWASocket, { makeInMemoryStore } from 'AustiinOffc/Baileys'
...
await conn.sendMessage(id, {
    contacts: {
        displayName: 'AustiinOffc Baileys',
        contacts: [{ vcard }],
    },
})
```
...
await conn.sendMessage(jid, {
    product: {
        ...
        retailerId: 'AustiinOffc Baileys',
                ...
                payment_settings: [
                    {
                        ...
                        pix_static_code: {
                            merchant_name: 'AustiinOffc Baileys',
                            key: 'example@AustiinOffc Baileys.com',
    ...
    interactiveButtons: [
        {
            ...
            buttonParamsJson: JSON.stringify({
                ...
                additional_note: 'AustiinOffc Baileys',
...
Rich Message adalah fitur UI premium pada AustiinOffc Baileys yang mendukung markdown, code block, table, images, video, product card, social post, reels, sources, suggestions, dan tip dalam satu pesan.
...
conn.sendMessage(m.chat, {
  richMessage: {
    title: 'AustiinOffc AI',
    text: '# AustiinOffc AI\nHalo Website dan sumber ',

    code: {
      language: 'javascript',
      code: `const austin = "AustiinOffc";
console.log(\`Hello \${austin}!\`);`
    },

    table: [
      ['Nama', 'Role'],
      ['AustiinOffc', 'Developer']
    ],
    ...
    product: {
      ...
      price: '50k',
      sale_price: '35k',
      product_url: 'https://www.AustiinOffc.cloud/',
      image: {
    ...
    post: {
      ...
      comments_count: 0,
      shares_count: 0,
      post_url: 'https://www.AustiinOffc.cloud/',
      post_deeplink: 'AustiinOffc://',
    ...
    sources: [
      [
        ...
        'https://github.com/AustiinOffc',
        'GitHub'
      ]
    ],

    tip: '💡 Tips: Gunakan kode AUSTIN untuk diskon!',
    ...
    footer: '© 2025 AustiinOffc. All rights reserved.'
  }
}, { quoted: m })
```
...
conn.sendMessage(m.chat, {
  orderStatus: {
    ...
    title: 'AustiinOffc Shop',
    text: 'Silakan cek status pesanan Anda.',
    footer: 'Powered by AustiinOffc',
    referenceId: 'LV-001',
    status: 'PROCESSING',
    subtotalValue: 10000,
    subtotalOffset: 100,
...
await conn.sendMessage(
    id,
    {
        album: [{
        	image: {
        		url: 'https://example.com/AustiinOffc/Baileys.jpg'
        	},
        	caption: 'Hay'
        }, {
        	image: Buffer,
        	...
        	video: {
        		url: 'https://example.com/AustiinOffc/Baileys.mp4'
        	},
        	caption: 'Hay'
        }, {
        	video: Buffer,
...
import { downloadMediaMessage, getContentType } from 'AustiinOffc/Baileys'
...
<div align="center">
  <p>© 2026 Made With Love by <b>AustiinOffc</b></p>
</div>
